...
public class DigitSumChallenge {
    ...
    public static void main(String[] args) {
        System.out.println("Sum of digit in 125 is:" + sumdigit(125));
        System.out.println("Sum of digit in 1 is:" + sumdigit(1));
        System.out.println("Sum of digit in -125 is:" + sumdigit(-125));
        System.out.println("Sum of digit in 32123 is:" + sumdigit(32123));
    }
}
